...
SECRET_KEY = 'django-insecure-il9&(@#uv%+%^+gfs+nyla*!0r1t@%rqs9bz+j7m3!=bsb^%7*'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'], # added the template info
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Optionally, specify the location where static files should be collected when deploying to production:
STATIC_ROOT = BASE_DIR / 'staticfiles'  # Only needed for production

# Media files for user uploads (optional):
MEDIA_URL = '/media/'
